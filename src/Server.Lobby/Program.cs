...
namespace Server.Lobby
{
    ...
    internal class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Logger.Warn("Starting up Server.Lobby.");

            _keepRunning = true;

            using (var server = new RebornServer<ClientHandler>(new IPEndPoint(IPAddress.Any, 8005)))
            {
                ...
                Logger.Warn("Shutting down Server.Lobby.");
            }
